...
I'm Declan. I build things. Mostly software right now. Sometimes both. I enjoy creating.
...
- **[Construction Industry Agent](https://declankramper.com/everything-i-built)**: forward-deployed with mid-sized construction firm to automate procurement, submittals, and other document-heavy workflows where time can be saved and money can be found
...
- **[Magic Record Player](https://github.com/declankra/raspberryPiRecordPlayer)**: a Raspberry Pi + NFC scanner + Spotify API that allows you to listen to your memories (photos go on device -> corresponding song/playlist plays on speakers). feels like magic.
